    ...
    <div className="flex-1 p-8">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-[#14141E] rounded-2xl p-6 border border-gray-800">
          ...
          <h3 className="text-2xl sm:text-4xl font-bold mt-2 break-all">{transactions.length}</h3>
        </div>
        <div className="bg-[#14141E] rounded-2xl p-6 border border-gray-800">
          ...
          <h3 className="text-2xl sm:text-4xl font-bold mt-2 break-all">
            ...
            {totalIncome - expense < 0 ? (
              <span className="block text-red-400 text-sm sm:text-lg mt-2">(Over Budget)</span>
            ) : null}
          </h3>
        </div>
      </div>
